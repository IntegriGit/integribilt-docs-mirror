...
paths:
  /graph/thread-summary/user/{user_id}:
    post:
      ...
      description: >-
        Returns incremental thread summaries generated from messages in each
        thread associated with the user's graph.
      tags:
        - thread-summary
      parameters:
        - name: user_id
...
response, err := client.Graph.ThreadSummary.GetByUserID(
	context.TODO(),
	"user_id",
