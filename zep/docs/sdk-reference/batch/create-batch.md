...
paths:
  /batches:
    post:
      ...
      description: >-
        Create a draft batch that can be filled with graph episodes and thread
        messages.
      tags:
        - batch
      responses:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/apidata.CreateBatchRequest'
servers:
    ...
    apidata.CreateBatchRequest:
      ...
      properties:
        ignore_roles:
          ...
          description: >-
            Optional list of message role types to skip during graph ingestion
            for

            thread_message items in this batch. The messages are still stored
            and
      ...
      title: apidata.CreateBatchRequest
